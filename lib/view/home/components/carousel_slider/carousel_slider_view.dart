...
import 'package:semo/model/ad_banner.dart';
import 'package:semo/view/home/components/carousel_slider/banner_card.dart';
...
class _CarouselSliderViewState extends State<CarouselSliderView> {
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        CarouselSlider(
            items: _bannerList, options: CarouselOptions(autoPlay: true))
      ],
    );
  }
}
